...
public class DemoHW {
    ...
    public static void main(String[] args) {
        ...
        MessageService messageService = new MessageServiceThroughFileSerialization("d:\\JavaSchool\\Task001\\src\\JavaSchoolRND2016\\src\\main\\java\\ru\\sbertech\\test\\lesson9\\homework\\Text.txt");
        switch (args[0]) {
            case "client":
